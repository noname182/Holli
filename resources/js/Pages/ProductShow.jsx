...
import Layout from '@/Layouts/MainLayout'; // Importamos tu Layout
...
export default function ProductShow({ variant }) {
    ...
    // Formateo de peso idéntico al ProductCard
    ...
    // Obtenemos la URL desde la relación multimedia (foto 1 y 2)
    ...
    return (
        <Layout> 
            ...
            <div className="min-h-[80vh] bg-[#b19149] py-12 px-4 flex items-center justify-center">
                <div className="max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-12 items-center bg-white rounded-[40px] p-6 md:p-12 shadow-sm border border-gray-50">
                    ...
                    <div className="flex flex-col h-full justify-center">
                        <span className="text-[#008542] font-black text-sm uppercase tracking-widest mb-2">Categoría</span>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 mt-auto">
                            ...
                            <button 
                                onClick={handleAddToCart} // 🚀 Esta es la conexión clave
